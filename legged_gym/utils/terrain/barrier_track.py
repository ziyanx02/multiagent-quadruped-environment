...
class BarrierTrack:
    ...
    def get_init_block_track(self,
        ...
        track_trimesh = convert_heightfield_to_trimesh(
            self.fill_heightfield_to_scale(block_heighfield),
    ...
    def add_track_to_sim(self, track_origin_px, row_idx= None, col_idx= None):
        ...
        for block_idx, block_name in enumerate(block_order):
            ...
            self.track_info_map[row_idx, col_idx, block_idx, 0] = self.track_options_id_dict[block_name]
            self.track_info_map[row_idx, col_idx, block_idx, 1:] = block_info
        ...
        for obstacle_idx, obstacle_selection in enumerate(obstacle_order):
            ...
            # For example get_climb_track, get_tilt_track, get_dualrun_track
    ...
    def add_terrain_to_sim(self, gym, sim, device= "cpu"):
        ...
        for col_idx in range(self.cfg.num_cols):
            ...
            for row_idx in range(self.cfg.num_rows):
                ...
                env_origin = self.add_track_to_sim(
                    self.track_origins_px[row_idx, col_idx],
                    row_idx = row_idx,
                    col_idx = col_idx,
                )
    ...
    def get_dualrun_penetration_depths(self,
            block_infos,
            positions_in_block,
            mask_only= False,
        ):
